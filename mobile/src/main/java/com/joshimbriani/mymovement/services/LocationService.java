...
public class LocationService extends Service {
    ...
    private static String TAG = "com.joshimbriani.mymovement.locationservice";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                MovementPoint movementPoint = new MovementPoint(serviceId, locationResult.getLastLocation().getLatitude(), locationResult.getLastLocation().getLongitude(), "mobile");
